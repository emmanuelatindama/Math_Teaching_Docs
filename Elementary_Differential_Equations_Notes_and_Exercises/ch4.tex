...
\begin{example}
  Given that 
  \begin{enumerate}[(i)]
    \item \(y_p = -4x^2\) is a particular solution of the nonhomogeneous equation \(y'' - 3y' + 4y = -16x^2 + 24x - 8\),
    \item \(y_p = e^{2x}\) is a particular solution of the nonhomogeneous equation \(y'' - 3y' + 4y = 2e^{2x}\), and 
    \item \(y_p = xe^x\) a particular solution of the nonhomogeneous equation \(y'' - 3y' + 4y = 2xe^{x} - e^x\)
  \end{enumerate}
...
\caption{Candidate trial solutions for the Method of Undetermined Coefficients with adjustment rule.
\textbf{Note:} $P_n(x)$ is a polynomial of degree $n$, and any representation of \(\cos\) applies for \(\sin\) as well.}
