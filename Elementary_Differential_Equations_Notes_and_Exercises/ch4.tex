...
\begin{example}
  \begin{enumerate}[(a)]
    ...
    \item Is \(y_p = -\frac{11}{12}x - \frac{1}{2}x\) a particular solution of the nonhomogeneous equation \(y''' - 6y'' + 11y' -6y= 3x\)?
  \end{enumerate}
\end{example}
...
second-order linear \textcolor{red}{homogeneous} ODE when one solution is already known.
